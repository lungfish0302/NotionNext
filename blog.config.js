...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '请注意垃圾分类', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '来宾请掌声鼓励！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rubbishbean.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '废话篓子', // 网站关键词 英文逗号隔开
